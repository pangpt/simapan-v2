...
class MasterSatkerSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('sub_kegiatan_satker')->insert([
            ['kegiatan_satker_id' => '1','kode_subkegiatan' => '1053.1905.QBA',  'nama_subkegiatan' => 'Layanan Bantuan Hukum Perseorangan','created_at' => $now, 'updated_at' => $now],
		]);

        DB::table('menu_satker')->insert([
            ['sub_kegiatan_satker_id' => '1','kode_menu' => '1053.QBA.001',  'nama_menu' => 'Perkara di Lingkungan Peradilan Agama yang diselesaikan melalui pembebasan biaya perkara' => $now, 'updated_at' => $now],
        ...
        DB::table('rincian_satker')->insert([
            ['menu_satker_id' => '1','kode_rincian' => '051',  'nama_rincian' => 'Pembebasan Biaya Perkara','created_at' => $now, 'updated_at' => $now],
            ['menu_satker_id' => '2','kode_rincian' => '051',  'nama_rincian' => 'Sidang di Luar Gedung Pengadilan','created_at' => $now, 'updated_at' => $now],
            ['menu_satker_id' => '3','kode_rincian' => '051',  'nama_rincian' => 'Pos Bantuan Hukum','created_at' => $now, 'updated_at' => $now],
            ['menu_satker_id' => '4','kode_rincian' => '051',  'nama_rincian' => 'Layanan Sidang Terpadu','created_at' => $now, 'updated_at' => $now],
		]);
        ...
        DB::table('uraian_satker')->insert([
            ['nama_uraian' => 'bantuan Pembebasan Panjar Biaya Perkara', 'created_at' => $now, 'updated_at' => $now],
            ['nama_uraian' => 'Biaya Uang Kebersihan', 'created_at' => $now, 'updated_at' => $now],
            ['nama_uraian' => 'Uang Harian', 'created_at' => $now, 'updated_at' => $now],
            ['nama_rincian' => 'Transportasi', 'created_at' => $now, 'updated_at' => $now],
            ['nama_rincian' => 'Honor Pejabat Panitia Pengadaan Barang Jasa', 'created_at' => $now, 'updated_at' => $now],
            ['nama_rincian' => 'Jasa Konsultan Hukum POSBAKUM', 'created_at' => $now, 'updated_at' => $now],
            ['nama_rincian' => 'Uang Harian', 'created_at' => $now, 'updated_at' => $now],
            ['nama_rincian' => 'Transportasi' => $now, 'updated_at' => $now],
        ]);
