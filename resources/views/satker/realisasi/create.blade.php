...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Input Realisasi</h1>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div>
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Form Input Realisasi</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{route('realisasisatker.input')}}" method="POST" enctype="multipart/form-data">
                @csrf
              <div class="card-body">
                  <div class="row">
                      <div class="col-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width:100%" name="satker">
                                  ...
                                  <option value="309076 - 005.04.BF Program Penegakan dan Pelayanan Hukum">309076 - 005.04.BF Program Penegakan dan Pelayanan Hukum</option>
                              </select>
                        </div>
                        </div>
                      <div class="col-6">
                      ...
                      <div class="form-group">
                        ...
                        <option value="">- Pilih Program - </option>
                        @foreach($programsatker as $menuid)
                            <option value="{{$menuid->id}}">
                                {{$menuid->kode_program}}-{{$menuid->nama_program}}
                            </option>
                            @endforeach
                        </select>
                    </div>
