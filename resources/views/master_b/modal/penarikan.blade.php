            ...
            <div class="modal-body">
                    <div class="row">
                        ...
                        <!-- text input -->
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Sisa Pagu</label>
                                <div class="col-sm-4">
                                <input type="text" id="sisa" class="form-control" name="sisa_pagu" disabled>
                                </div>
                            </div>
                            @foreach($month as $mo)
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                <input type="text" class="form-control" name="pagu_{{$mo->slug}}" id="{{$mo->slug}}" value="" max="200000">
                                </div>
                            </div>
                            @endforeach
                        </div>
